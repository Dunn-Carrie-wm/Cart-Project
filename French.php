...
<div id="container">
    ...
    <div id=" product" style="width: 600px; height: 600px; margin-top: 3%; margin-left: 2%">
        <img src="http://www.myamericanmarket.com/components/com_virtuemart/shop_image/product/PRINGLES_FRENCH_ONION_DIP_CHIPS_400.jpg" style="height: 500px; width: 500px; margin-top: 7%; margin-left: 7%;">
    </div>
