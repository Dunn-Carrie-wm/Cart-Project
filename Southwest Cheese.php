...
<div id="container">
    <div id="description" style="height: 700px; width: 500px; float: right; margin-right: 4%">
        <div id="price" style="height: 400px; width: 499px; margin-top: 5%">
            <h1 style="text-align: center; text-decoration: underline;">SouthWest Cheese</h1>
            <br>
            <br>
            <p style="font-size: medium; text-align: center;">You know what's better than 1 can of pringles?
                ...
                These SouthWest Cheese flavored goodness are at a stealing rate of 1 dollar a can.
    ...
    <img src="https://c2.staticflickr.com/6/5221/14103220475_6c7fd2e16e_b.jpg" style="height: 500px; width: 500px; margin-top: 10%; margin-left: 5% ">
</div>
